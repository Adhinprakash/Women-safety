...
sendMessage(String googlemaplink,Location?clocation)async{
  String messageBody =
          // "🆘 EMERGENCY ALERT 🆘\n\n"
          "I am in trouble and need help!!\n"
          "$googlemaplink\n";
           "GPS: ${clocation!.latitude}, ${clocation.longitude}\n";
  ...
  await  Telephony.backgroundInstance.sendSms(to: contact.phone, message: messageBody).then((value){
    ...
    if (await service.isForegroundService()) {
      ...
      ShakeDetector.autoStart(
          ...
          onPhoneShake: (_) async {
            ...
            sendMessage(googleMapsLink,clocation);
          });
